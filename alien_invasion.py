...
class AlienInvasion:
    ...
    def _quit_game(self):
        """Saves the high score and quits."""
    ...
    def _create_fleet(self):
        ...
        #Create an alien and find the number of aliens on the row.
    ...
    def _update_aliens(self):
        """Check if the fleet has hit the edge and
            update the positions of all aliens in the fleet."""
        self._check_fleet_edges()
        self.aliens.update()

        #Check if the ship has been hit or the bottom reached.
    ...
    def _change_fleet_direction(self):
        """Drop the fleet and changes the fleet's direction."""
        for alien in self.aliens.sprites():
