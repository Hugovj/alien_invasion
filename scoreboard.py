...
class Scoreboard:
    ...
    def prep_images(self):
        """Preps all the initial images, except high score."""
        self.prep_level()
        self.prep_score()
        self.prep_ships()
    ...
    def prep_level(self):
        ...
        level_str = f"level {level_number}"
    ...
    def prep_high_score(self):
        ...
        #Centre at the top of the screen.
    ...
    def prep_score(self):
        ...
        self.score_rect.right = self.level_rect.right
